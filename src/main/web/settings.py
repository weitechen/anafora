...
STATICFILES_DIRS = (
    ...
    '',
    '/home/wtchen/Research/anaforaDevelop/src/main/static',
    )
...
SECRET_KEY = '@#(cxkj8!Q#WREsdvg8123'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/wtchen/Research/anaforaDevelop/src/Templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TEMPLATE_DIRS = (
    '/home/wtchen/Research/anaforaDevelop/src/Templates',
...
TEST_RUNNER = 'web.scripts.testrunner.NoDbTestRunner'
...
ANAFORA_PROJECT_FILE_ROOT = "/home/wtchen/Research/anaforaDevelop/sample data/sampleanaforaprojectfile/"

# Set this value to "True" if using LDAP Authentication. Set to "False" if using Digest auth file
