...
class AnnotateURLTest(unittest2.TestCase):
	...
	def test_getXML(self):
		...
		resolver = resolve('/annotate/setCompleted/THYMEColonFinal/Test/ID031_clinic_091/Thyme2v1.Coreference/')
		self.assertEqual(resolver.view_name, 'annotate.views.setCompleted')
		...
		resolver = resolve('/annotate/setCompleted/THYMEColonFinal/Dev/ID036_clinic_108/TimeNorm.Adjudication/')
		self.assertEqual(resolver.view_name, 'annotate.views.setCompleted')
		...
		resolver = resolve('/annotate/setCompleted/THYMEColonFinal/Dev/ID036_clinic_108/TimeNorm/')
		self.assertEqual(resolver.view_name, 'annotate.views.setCompleted')
