...
class ProjectSetting(object):
    ...
    def parseFromFile(self, filePath):
        ...
        try:
            ...
            raise ImproperlyConfigured("Can not find setting file '%s', please check your setting of "
                                       "``ANAFORA_PROJECT_FILE_ROOT'' and ``ANAFORA_PROJECT_SETTING_FILENAME'' in "
                                       "your setting file" % (filePath))
